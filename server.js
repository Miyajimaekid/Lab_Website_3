...
app.get('/player_info/post', function(req, res){
	...
	var query3 = "select COUNT(*) from football_games WHERE '" + req.query.player_choice + "'=ANY(players);";
	db.task('get-everything', task => {
	    return task.batch([
	        task.any(query1),
	        task.any(query2),
	...
	.catch(error => {
	    // display error message ino case an error
